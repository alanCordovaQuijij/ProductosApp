...
import { LoginData, LoginResponse, RegisterData, Usuario, errorLogin } from "../interfaces/appInterfaces";
...
export const AutContext = createContext({} as AutContexProps);
...
export const AuthProvider = ({children}: any) => {
   ...
   const singUp = async ({nombre, correo, password}: RegisterData) => {
    try {
        ...
        dispatch({
            type:'addError',
            payload: error.response.data.errors[0].msg || 'Por favor revise la información'
        })
    }
   };
